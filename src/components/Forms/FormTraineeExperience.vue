<template>
  <div id="FormTraineeExperience" v-if="!loading">
    <div class="form_information">
      ...
      <el-form label-position="labelPosition" label-width="200px" class="animated fadeIn" :rules="rules" :status-icon="true" :model="formTrainee" ref="formsTrainee" >
        <div class="resume_form-items">
          <el-form-item label="起始日期" prop="startTime">
            <el-date-picker type="date" placeholder="选择日期" v-model="formTrainee.startTime"></el-date-picker>
          </el-form-item>
          <el-form-item label="结束日期" prop="endTime" ref="formTrainee">
            <el-date-picker type="date" placeholder="选择日期" v-model="formTrainee.endTime"></el-date-picker>
          </el-form-item>
